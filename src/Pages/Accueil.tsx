...
export default function Accueil() {
  ...
  // permet de remettre à zéro l'état de l'application
  const resetState = () => {
    setMessage(null);
  ...
  // permet de recharger la page (ctrl + r)
  const rechargerPage = () => {
  ...
  return (
    <Box className="container-accueil">
      <Toaster />
      <Box className="bouton-recharge">
